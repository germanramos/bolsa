...
#LLAVE=`curl --silent http://www.expansion.com/mercados/cotizaciones/valores/abertis_M.ABE.html | grep ";var llave" | cut -d '"' -f 6`
#LLAVE=`curl --silent http://www.expansion.com/mercados/cotizaciones/valores/abertis_M.ABE.html | grep ">var llave" | cut -d '"' -f 2`
